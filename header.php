...
<body>
    <header class="flex flex-row bg-white flex-1 w-full h-40 justify-around items-center py-6 px-10 bg-url[<?php bloginfo('template_directory')?>/img/bgtexture.jpg] bg-cover">  
