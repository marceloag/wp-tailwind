<?php get_header(); ?>
    <section class="w-full relative block shadow-lg shadow-slate-600" id="hero">
      ...
      <div class="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex flex-col gap-3 w-2/5 text-center">
          <h1 class="[text-wrap:balance] text-6xl font-serif text-[#2D1D0C]">Lorem Ipsum dolor sit amet</h1>
          <a href="" class="text-[#2D1D0C] w-full py-4 text-center border-solid border-1 border-[#2D1D0C] flex flex-row items-center justify-between uppercase">
            Nuestros Productos
