<?php get_header(); ?>
    <section class="w-full relative block shadow-lg shadow-slate-600" id="hero">
      ...
      <div class="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex flex-col gap-3 w-2/5 items-center justify-center text-center">
          ...
          <a href="" class="text-[#2D1D0C] w-2/5 py-4 text-center border-solid border-2 border-[#2D1D0C] flex flex-row items-center justify-around uppercase">
            Nuestros Productos
    ...
    <section id="gallery" class="flex w-full my-10 p-10">
      <div class="grid grid-cols-4 grid-rows-2 gap-8">
        <div class="row-span-2"><img src="<?php bloginfo("template_directory")?>/img/peonias01.webp" alt="Peonias" class="w-full object-contain min-h-0 h-full"></div>
